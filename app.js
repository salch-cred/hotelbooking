document.addEventListener('DOMContentLoaded', function () {
  ...
  function renderBookingsTable() {
    ...
    // Re-hook custom cursor dynamics over newly rendered buttons
    hookCursorMicroInteractions();
  }
  ...
  // Navigation button links inside Drawer
  ...
  // Live calculates step 3 receipt values
  ...
  btnNext.addEventListener('click', () => {
    if (currentFormStep === 1) {
      ...
      // Reset forms & steps back to baseline
